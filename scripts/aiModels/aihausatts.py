...
with open('20%hausa.txt', 'r', encoding='utf-8') as file:
...
for idx, line in enumerate(lines):
    ...
    wav_filename = f"hausa_line_{idx}.wav"
...
combined_audio.export("hausa_combined.wav", format="wav")
print("All audio files have been combined into 'hausa_combined.wav'")
